...
[![Go Report Card](https://goreportcard.com/badge/github.com/DUDeJayDev/makesite)](https://goreportcard.com/report/github.com/DUDeJayDev/makesite)
...
Complete the MVP, if you finish early, move on to the stretch challenges.
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the progressbar library. The documentation is located at https://github.com/schollz/progressbar. My goal is to use it to show the progress of the iteration.`
